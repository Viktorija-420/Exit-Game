...
func _start_level_transition() -> void:
	print("Level 7: Transition triggered!")
	_transitioning = true
	...
	if fade_rect:
		...
		t.finished.connect(func():
			print("Level 7: Fade complete. Switching NOW.")
			get_tree().change_scene_to_file("res://level_8.tscn")
		)
	else:
		print("Level 7: No fade rect found, switching immediately.")
		get_tree().change_scene_to_file("res://level_8.tscn")
