...
func _start_level_transition() -> void:
	print("Level 6: Transition triggered!")
	_transitioning = true
	...
	if fade_rect:
		...
		t.finished.connect(func():
			print("Level 6: Fade complete. Switching NOW.")
			get_tree().change_scene_to_file("res://level_7.tscn")
		)
	else:
		print("Level 6: No fade rect found, switching immediately.")
		get_tree().change_scene_to_file("res://level_7.tscn")
