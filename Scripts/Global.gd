...
# Globālie spēles stāvokļa mainīgie
var max_lives: int = 5 
var lives: int = 5
...
# Mainīgais ar getter/setter loģiku
var has_key: bool:
	get: return _has_key
	set(value):
		_has_key = value
...
func _ready() -> void: 
	...
	# ✅ AUTOMĀTISKI IELĀDĒ IESTATĪJUMUS, KAD PALAIŽ SPĒLI
...
# --- VISS JAUNAIS IESTATĪJUMU APSTRĀDES APGABALS ---

func apply_saved_settings_globally() -> void:
	var config = ConfigFile.new()
	var err = config.load(SAVE_PATH)
	
	# Ja fails neeksistē (pirmā palaišana), piemērojam noklusētos iestatījumus
	if err != OK:
