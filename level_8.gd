...
func _start_level_transition() -> void:
	print("Level 8: Transition triggered!")
	_transitioning = true
	...
	if fade_rect:
		...
		t.finished.connect(func():
			print("Level 8: Fade complete. Switching NOW.")
			get_tree().change_scene_to_file("res://level_9.tscn")
		)
	else:
		print("Level 8: No fade rect found, switching immediately.")
		get_tree().change_scene_to_file("res://level_9.tscn")
